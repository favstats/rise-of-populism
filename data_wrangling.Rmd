...
ess %<>% 
  mutate(populism = case_when(
    ...
    str_detect(prtvt, "VMRO") ~ "Illiberal Populism",   
    # prtvt == "PP VMRO - Balgarsko natsionalno dvizhenie" ~ "Illiberal Populism", 
    prtvt == "Partia Ataka" ~ "Illiberal Populism",     
    ...
    prtvt == "Izquierda Unida (IU)" ~ "Liberal Populism",
    ...
    prtvt == "The Left Alliance" ~ "Liberal Populism", 
    ...
    #prtvt == "Parti Radical de Gauche" ~ "Liberal Populism",    
    ...
    str_detect(prtvt, "Die Linke") ~ "Liberal Populism",
    ...
    prtvt == "The Communist Party of Greece (KKE)" ~ "Liberal Populism",
    ...
    str_detect(prtvt, "Jobbik") ~ "Illiberal Populism",
    #prtvt == "Jobbik (Jobbik Magyarországért Mozgalom)" ~ "Illiberal Populism",
    str_detect(prtvt, "LMP") ~ "Liberal Populism",

    #Ireland
    prtvt == "Green Party" & cntryname == "Ireland" ~ "Liberal Populism",
    prtvt == "Sinn Féin" ~ "Liberal Populism",
    prtvt == "Anti-Austerity Alliance - People Before Profit" ~ "Liberal Populism",
    prtvt == "People Before Profit" ~ "Liberal Populism",
    str_detect(prtvt, "United Left Alliance") ~ "Liberal Populism",
    ...
    prtvt == "Slovak National Party (SNS)" ~ "Illiberal Populism",    
...
ess %<>% 
  mutate(popul2 = case_when(
    ...
    #Bulgaria
    str_detect(prtcl, "Ataka") ~ "Illiberal Populism",
    str_detect(prtcl, "VMRO") ~ "Illiberal Populism", 
    ...
    str_detect(prtcl, "Enhedlisten") ~ "Liberal Populism",
    ...
    str_detect(prtcl, "Linke") ~ "Liberal Populism",
    ...
    #Spain
    str_detect(prtcl, "AMAIUR") ~ "Liberal Populism",
    str_detect(prtcl, "Izquierda Unida") ~ "Liberal Populism",
    ...
    prtcl == "The Left Alliance " ~ "Liberal Populism",
    ...
    #Hungary
    str_detect(prtcl, "Jobbik") ~ "Illiberal Populism",
    str_detect(prtcl, "LMP") ~ "Liberal Populism",
    ...
    prtcl == "People Before Profit" ~ "Liberal Populism",
    str_detect(prtcl, "United Left Alliance") ~ "Liberal Populism",
    ...
    str_detect(prtc, "Sverige") ~ "Illiberal Populism", 
...
#     prtcl == "Eesti Vabaerakond" ~ "Liberal Populism",
    ...
    prtcl == "Slovak National Party (SNS)" ~ "Illiberal Populism",    
