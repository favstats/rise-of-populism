...
*methods*
all the same colors!
description of parties (auslagern?)
summary statistics - just make it fit
*analysis*
Probability Plots for the main hypotheses - describe them
check for irregularities
finish this part!
conclusion -> probably needs table
*appendix*
...
ggsave(filename = "images/control_probs.png", width = 18, height = 10)
...
ggsave(filename = "images/lrscale_probs.png", width = 9, height = 6)
```
...
ggsave(filename = "images/regyears_probs.png", width = 18, height = 10)
```
...
ggsave(filename = "images/cultural_probs2.png", width = 18, height = 10)
...
ggsave(filename = "images/economic_probs.png", width = 18, height = 10)
```
